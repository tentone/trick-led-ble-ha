...
import com.qh.WheelView.WheelScroller;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.scrollingListener = new WheelScroller.ScrollingListener() { // from class: com.qh.WheelView.WheelView.1
            @Override // com.qh.WheelView.WheelScroller.ScrollingListener
        ...
        this.dataObserver = new DataSetObserver() { // from class: com.qh.WheelView.WheelView.2
    ...
    private int calculateLayoutWidth(int i, int i2) {
        ...
        if (i2 != 1073741824) {
            int iMax = Math.max(measuredWidth + 2, getSuggestedMinimumWidth());
            if (i2 != Integer.MIN_VALUE || i >= iMax) {
                i = iMax;
            }
        }
        this.itemsLayout.measure(View.MeasureSpec.makeMeasureSpec(i - 2, 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
        return i;
    }
    ...
    private void layout(int i, int i2) {
        this.itemsLayout.layout(0, 0, i - 2, i2);
    }
    ...
    private void drawItems(Canvas canvas) {
        canvas.save();
        canvas.translate(1.0f, (-(((this.currentItem - this.firstItem) * getItemHeight()) + ((getItemHeight() - getHeight()) / 2))) + this.scrollingOffset);
    ...
    private ItemsRange getItemsRange() {
        ...
        if (i3 != 0) {
            ...
            i -= itemHeight;
            double d = i2 + 1;
            double dAsin = Math.asin(itemHeight);
            Double.isNaN(d);
            i2 = (int) (d + dAsin);
        }
