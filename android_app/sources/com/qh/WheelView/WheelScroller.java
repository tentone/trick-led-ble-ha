...
public class WheelScroller {
    ...
    private GestureDetector.SimpleOnGestureListener gestureListener = new GestureDetector.SimpleOnGestureListener() { // from class: com.qh.WheelView.WheelScroller.1
    ...
    private Handler animationHandler = new Handler() { // from class: com.qh.WheelView.WheelScroller.2
